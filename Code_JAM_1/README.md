First all what we need is data of students which can be collected by webscrapping and storing them with help of sqlite3 and then convert it into a csv file this step can be done only once ..
